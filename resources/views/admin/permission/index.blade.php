    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">Data Permissions</h4>
                </div>
  ...
  <div class="col-6">
      <div class="card m-b-30">
          <div class="card-body">
              ...
              <h4 class="mt-0 header-title">List Data Permissions</h4>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="button-items">
                        ...
                        <form method="POST"  class="d-inline" id="formsubmit" action="{{ url('administrator/permission/delpermission/'.$item->id) }}">@csrf
   ...
   @forelse ($permission as $item_eedit)
   <div id="myModal{{ $item_eedit->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form method="post" action="{{ url('administrator/permission/editpermission/'. $item_eedit->id ) }}" enctype="multipart/form-data" > {{ csrf_field() }}
...
@endforelse
  ...
  <div class="col-6">
    ...
    @include('admin.templates.message')
      ...
      <form method="post" action="{{ url('administrator/permission/addpermission') }}" enctype="multipart/form-data" > {{ csrf_field() }}
        <div class="form-group">
            <label>Name Permissions</label>
